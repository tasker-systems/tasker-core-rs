...
-- =============================================================================
-- READY TASKS VIEW (Updated for UUID v7)
-- =============================================================================
...
-- Task claiming indexes for orchestration
CREATE INDEX IF NOT EXISTS idx_tasker_tasks_claiming
    ON tasker_tasks (claimed_at, claimed_by)
    WHERE claimed_at IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_tasker_tasks_unclaimed
    ON tasker_tasks (complete, priority, created_at)
