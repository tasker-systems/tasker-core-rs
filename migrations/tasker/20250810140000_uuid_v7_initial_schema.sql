...
--
-- TAS-78: Tasker-specific schema (PGMQ extensions and headers moved to pgmq/ migrations)
--
-- This migration creates the complete Tasker schema with UUID v7 primary keys
...
-- Enable required extension for UUID v7
-- NOTE: pgmq extension is installed via pgmq/ migrations (TAS-78)
