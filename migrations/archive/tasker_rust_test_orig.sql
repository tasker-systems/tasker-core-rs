...
--
-- Name: calculate_dependency_levels(bigint); Type: FUNCTION; Schema: public; Owner: tasker
--
...
ALTER FUNCTION public.calculate_dependency_levels(input_task_id bigint) OWNER TO tasker;

--
-- Name: claim_ready_tasks(character varying, integer, character varying); Type: FUNCTION; Schema: public; Owner: tasker
--

CREATE FUNCTION public.claim_ready_tasks(p_orchestrator_id character varying, p_limit integer DEFAULT 1, p_namespace_filter character varying DEFAULT NULL::character varying) RETURNS TABLE(task_id bigint, namespace_name character varying, priority integer, computed_priority double precision, age_hours double precision, ready_steps_count bigint, claim_timeout_seconds integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: FUNCTION claim_ready_tasks(p_orchestrator_id character varying, p_limit integer, p_namespace_filter character varying); Type: COMMENT; Schema: public; Owner: tasker
--

COMMENT ON FUNCTION public.claim_ready_tasks(p_orchestrator_id character varying, p_limit integer, p_namespace_filter character varying) IS 'Atomically claim tasks with priority fairness ordering. Includes computed_priority and age_hours for monitoring starvation prevention.';


--
-- Name: extend_task_claim(bigint, character varying); Type: FUNCTION; Schema: public; Owner: tasker
--

CREATE FUNCTION public.extend_task_claim(p_task_id bigint, p_orchestrator_id character varying) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION public.extend_task_claim(p_task_id bigint, p_orchestrator_id character varying) OWNER TO tasker;

--
-- Name: FUNCTION extend_task_claim(p_task_id bigint, p_orchestrator_id character varying); Type: COMMENT; Schema: public; Owner: tasker
--

COMMENT ON FUNCTION public.extend_task_claim(p_task_id bigint, p_orchestrator_id character varying) IS 'Extend claim timeout while processing (heartbeat). Prevents stale claim detection during long operations.';
...
--
-- Name: get_step_readiness_status(bigint, bigint[]); Type: FUNCTION; Schema: public; Owner: tasker
--
...
ALTER FUNCTION public.get_step_readiness_status(input_task_id bigint, step_ids bigint[]) OWNER TO tasker;

--
-- Name: get_step_readiness_status_batch(bigint[]); Type: FUNCTION; Schema: public; Owner: tasker
--
...
ALTER FUNCTION public.get_step_readiness_status_batch(input_task_ids bigint[]) OWNER TO tasker;

--
-- Name: get_step_transitive_dependencies(bigint); Type: FUNCTION; Schema: public; Owner: tasker
--

CREATE FUNCTION public.get_step_transitive_dependencies(target_step_id bigint) RETURNS TABLE(workflow_step_id bigint, task_id bigint, named_step_id integer, step_name character varying, results jsonb, processed boolean, distance integer)
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
    RETURN QUERY
...
ALTER FUNCTION public.get_step_transitive_dependencies(target_step_id bigint) OWNER TO tasker;
...
--
-- Name: get_task_execution_context(bigint); Type: FUNCTION; Schema: public; Owner: tasker
--
...
ALTER FUNCTION public.get_task_execution_context(input_task_id bigint) OWNER TO tasker;

--
-- Name: get_task_execution_contexts_batch(bigint[]); Type: FUNCTION; Schema: public; Owner: tasker
--
...
ALTER FUNCTION public.get_task_execution_contexts_batch(input_task_ids bigint[]) OWNER TO tasker;
...
--
-- Name: release_task_claim(bigint, character varying); Type: FUNCTION; Schema: public; Owner: tasker
--

CREATE FUNCTION public.release_task_claim(p_task_id bigint, p_orchestrator_id character varying) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_rows_updated integer;
...
ALTER FUNCTION public.release_task_claim(p_task_id bigint, p_orchestrator_id character varying) OWNER TO tasker;

--
-- Name: FUNCTION release_task_claim(p_task_id bigint, p_orchestrator_id character varying); Type: COMMENT; Schema: public; Owner: tasker
--

COMMENT ON FUNCTION public.release_task_claim(p_task_id bigint, p_orchestrator_id character varying) IS 'Release a task claim when done processing or on error. Only releases if caller owns the claim.';
...
--
-- Name: tasker_dependent_systems_dependent_system_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_dependent_systems_dependent_system_id_seq OWNER TO tasker;

--
-- Name: tasker_dependent_systems_dependent_system_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_steps_named_step_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_named_steps_named_step_id_seq OWNER TO tasker;

--
-- Name: tasker_named_steps_named_step_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks_named_steps_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_named_tasks_named_steps_id_seq OWNER TO tasker;

--
-- Name: tasker_named_tasks_named_steps_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks_named_task_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_named_tasks_named_task_id_seq OWNER TO tasker;

--
-- Name: tasker_named_tasks_named_task_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: COLUMN tasker_tasks.claimed_at; Type: COMMENT; Schema: public; Owner: tasker
--
...
--
-- Name: COLUMN tasker_tasks.claimed_by; Type: COMMENT; Schema: public; Owner: tasker
--
...
--
-- Name: COLUMN tasker_tasks.priority; Type: COMMENT; Schema: public; Owner: tasker
--
...
--
-- Name: COLUMN tasker_tasks.claim_timeout_seconds; Type: COMMENT; Schema: public; Owner: tasker
--
...
CREATE VIEW public.tasker_ready_tasks AS
 SELECT t.task_id,
   ...
   FROM (((public.tasker_tasks t
     JOIN public.tasker_named_tasks nt ON ((t.named_task_id = nt.named_task_id)))
     JOIN public.tasker_task_namespaces tn ON ((nt.task_namespace_id = tn.task_namespace_id)))
     JOIN LATERAL ( SELECT get_task_execution_context.task_id,
            get_task_execution_context.named_task_id,
           ...
           FROM public.get_task_execution_context(t.task_id) get_task_execution_context(task_id, named_task_id, status, total_steps, pending_steps, in_progress_steps, completed_steps, failed_steps, ready_steps, execution_status, recommended_action, completion_percentage, health_status)) tec ON (true))
  WHERE ((t.complete = false) AND (tec.ready_steps > 0) AND (tec.execution_status = ANY (ARRAY['in_progress'::text, 'pending'::text, 'has_ready_steps'::text])) AND ((t.claimed_at IS NULL) OR (t.claimed_at < (now() - ((t.claim_timeout_seconds || ' seconds'::text))::interval))))
  ORDER BY ((
        CASE
            WHEN (t.priority >= 4) THEN ((t.priority)::numeric + LEAST((EXTRACT(epoch FROM (now() - (t.created_at)::timestamp with time zone)) / (300)::numeric), (2)::numeric))
            WHEN (t.priority = 3) THEN ((t.priority)::numeric + LEAST((EXTRACT(epoch FROM (now() - (t.created_at)::timestamp with time zone)) / (180)::numeric), (3)::numeric))
...
--
-- Name: VIEW tasker_ready_tasks; Type: COMMENT; Schema: public; Owner: tasker
--
...
CREATE TABLE public.tasker_workflow_steps (
    ...
    updated_at timestamp(6) without time zone NOT NULL,
    skippable boolean DEFAULT false NOT NULL,
    step_uuid uuid DEFAULT gen_random_uuid() NOT NULL
);
...
--
-- Name: tasker_task_namespaces_task_namespace_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_task_namespaces_task_namespace_id_seq OWNER TO tasker;

--
-- Name: tasker_task_namespaces_task_namespace_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_transitions_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_task_transitions_id_seq OWNER TO tasker;

--
-- Name: tasker_task_transitions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_tasks_task_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_tasks_task_id_seq OWNER TO tasker;

--
-- Name: tasker_tasks_task_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_edges_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_workflow_step_edges_id_seq OWNER TO tasker;

--
-- Name: tasker_workflow_step_edges_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_transitions_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_workflow_step_transitions_id_seq OWNER TO tasker;

--
-- Name: tasker_workflow_step_transitions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_steps_workflow_step_id_seq; Type: SEQUENCE; Schema: public; Owner: tasker
--
...
ALTER SEQUENCE public.tasker_workflow_steps_workflow_step_id_seq OWNER TO tasker;

--
-- Name: tasker_workflow_steps_workflow_step_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_dependent_systems dependent_system_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_steps named_step_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks named_task_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks_named_steps id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_namespaces task_namespace_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_transitions id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_tasks task_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_edges id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_transitions id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_steps workflow_step_id; Type: DEFAULT; Schema: public; Owner: tasker
--
...
-- 20250808095402	unified initial schema	2025-08-11 13:20:31.501189+00	t	\\x78a354bd6ee8877833fbc06a84656451501ee627a3d65336ea26e8507e63af06231c921e292225aea68cc07e319a8230	59624792
\.
...
COPY public.tasker_dependent_system_object_maps (dependent_system_object_map_id, dependent_system_one_id, dependent_system_two_id, remote_id_one, remote_id_two, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_dependent_systems (dependent_system_id, name, description, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_named_steps (named_step_id, dependent_system_id, name, description, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_named_tasks (named_task_id, name, description, created_at, updated_at, task_namespace_id, version, configuration) FROM stdin;
\.
...
COPY public.tasker_named_tasks_named_steps (id, named_task_id, named_step_id, skippable, default_retryable, default_retry_limit, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_task_annotations (task_annotation_id, task_id, annotation_type_id, annotation, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_task_namespaces (task_namespace_id, name, description, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_task_transitions (id, to_state, from_state, metadata, sort_key, most_recent, task_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_tasks (task_id, named_task_id, complete, requested_at, initiator, source_system, reason, bypass_steps, tags, context, identity_hash, created_at, updated_at, claimed_at, claimed_by, priority, claim_timeout_seconds, task_uuid) FROM stdin;
\.
...
COPY public.tasker_workflow_step_edges (id, from_step_id, to_step_id, name, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_workflow_step_transitions (id, to_state, from_state, metadata, sort_key, most_recent, workflow_step_id, created_at, updated_at) FROM stdin;
\.
...
COPY public.tasker_workflow_steps (workflow_step_id, task_id, named_step_id, retryable, retry_limit, in_process, processed, processed_at, attempts, last_attempted_at, backoff_request_seconds, inputs, results, created_at, updated_at, skippable, step_uuid) FROM stdin;
\.
...
--
-- Name: tasker_dependent_systems_dependent_system_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_dependent_systems_dependent_system_id_seq', 1, false);


--
-- Name: tasker_named_steps_named_step_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_named_steps_named_step_id_seq', 1, false);


--
-- Name: tasker_named_tasks_named_steps_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_named_tasks_named_steps_id_seq', 1, false);


--
-- Name: tasker_named_tasks_named_task_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_named_tasks_named_task_id_seq', 1, false);
...
--
-- Name: tasker_task_namespaces_task_namespace_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_task_namespaces_task_namespace_id_seq', 1, false);


--
-- Name: tasker_task_transitions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_task_transitions_id_seq', 1, false);


--
-- Name: tasker_tasks_task_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_tasks_task_id_seq', 1, false);


--
-- Name: tasker_workflow_step_edges_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_workflow_step_edges_id_seq', 1, false);


--
-- Name: tasker_workflow_step_transitions_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_workflow_step_transitions_id_seq', 1, false);


--
-- Name: tasker_workflow_steps_workflow_step_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tasker
--

SELECT pg_catalog.setval('public.tasker_workflow_steps_workflow_step_id_seq', 1, false);
...
--
-- Name: tasker_tasks tasker_tasks_task_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: tasker
--

ALTER TABLE ONLY public.tasker_tasks
    ADD CONSTRAINT tasker_tasks_task_uuid_unique UNIQUE (task_uuid);
...
--
-- Name: tasker_workflow_steps tasker_workflow_steps_step_uuid_unique; Type: CONSTRAINT; Schema: public; Owner: tasker
--

ALTER TABLE ONLY public.tasker_workflow_steps
    ADD CONSTRAINT tasker_workflow_steps_step_uuid_unique UNIQUE (step_uuid);


--
-- Name: annotation_types_name_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: annotation_types_name_unique; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_system_object_maps_dependent_system_one_id_dependent_; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_system_object_maps_dependent_system_one_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_system_object_maps_dependent_system_two_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_system_object_maps_remote_id_one_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_system_object_maps_remote_id_two_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_systems_name_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: dependent_systems_name_unique; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_named_steps_transitive_deps; Type: INDEX; Schema: public; Owner: tasker
--

CREATE INDEX idx_named_steps_transitive_deps ON public.tasker_named_steps USING btree (named_step_id) INCLUDE (name);


--
-- Name: idx_on_workflow_step_id_most_recent_97d5374ad6; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_on_workflow_step_id_sort_key_4d476d7adb; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_step_edges_from_to; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_step_edges_to_from; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_step_transitions_current_state; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_step_transitions_most_recent; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_steps_active_operations; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_task_transitions_most_recent; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_tasker_tasks_named_task_created; Type: INDEX; Schema: public; Owner: tasker
--

CREATE INDEX idx_tasker_tasks_named_task_created ON public.tasker_tasks USING btree (named_task_id, created_at) WHERE (complete = false);


--
-- Name: idx_tasker_tasks_priority_created; Type: INDEX; Schema: public; Owner: tasker
--

CREATE INDEX idx_tasker_tasks_priority_created ON public.tasker_tasks USING btree (priority DESC, created_at) WHERE (complete = false);
...
--
-- Name: idx_tasks_active_operations; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_tasks_active_workflow_summary; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_tasks_completion_status_created; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: idx_workflow_step_edges_dependency_lookup; Type: INDEX; Schema: public; Owner: tasker
--
...
CREATE INDEX idx_workflow_steps_transitive_deps ON public.tasker_workflow_steps USING btree (workflow_step_id, named_step_id) INCLUDE (task_id, results, processed);


--
-- Name: index_step_edges_child_lookup; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_dependency_pair; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_from_step_for_children; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_from_to_composite; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_parent_lookup; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_to_from_composite; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_edges_to_step_for_parents; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_completed; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_completed_parents; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_current_errors; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_current_state_optimized; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_failures_with_timing; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_step_transitions_for_current_state; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_task_transitions_current_state; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_task_transitions_current_state_optimized; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_task_transitions_on_sort_key; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_task_transitions_on_task_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_task_transitions_on_task_id_and_most_recent; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_task_transitions_on_task_id_and_sort_key; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_tasks_on_task_uuid; Type: INDEX; Schema: public; Owner: tasker
--

CREATE INDEX index_tasker_tasks_on_task_uuid ON public.tasker_tasks USING btree (task_uuid);


--
-- Name: index_tasker_workflow_step_edges_on_from_step_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_workflow_step_edges_on_to_step_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_workflow_step_transitions_on_sort_key; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_workflow_step_transitions_on_workflow_step_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_tasker_workflow_steps_on_step_uuid; Type: INDEX; Schema: public; Owner: tasker
--

CREATE INDEX index_tasker_workflow_steps_on_step_uuid ON public.tasker_workflow_steps USING btree (step_uuid);


--
-- Name: index_tasks_on_identity_hash; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_step_edges_dependency_lookup; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_backoff_timing; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_by_task; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_processing_status; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_retry_logic; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_retry_status; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_task_and_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_task_and_step_id; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_task_and_step_optimized; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: index_workflow_steps_task_covering; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_step_by_system_uniq; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_steps_dependent_system_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_steps_name_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_configuration_gin_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_name_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_named_steps_named_step_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_named_steps_named_task_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_namespace_name_version_unique; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_steps_ids_unique; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_task_namespace_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: named_tasks_version_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_annotations_annotation_idx; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_annotations_annotation_idx1; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_annotations_annotation_type_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_annotations_task_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_namespaces_name_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: task_namespaces_name_unique; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_context_idx; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_context_idx1; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_identity_hash_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_named_task_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_requested_at_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_source_system_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_tags_idx; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasks_tags_idx1; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: workflow_steps_last_attempted_at_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: workflow_steps_named_step_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: workflow_steps_processed_at_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: workflow_steps_task_id_index; Type: INDEX; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_dependent_system_object_maps dependent_system_object_maps_dependent_system_one_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_dependent_system_object_maps dependent_system_object_maps_dependent_system_two_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks fk_rails_16a0297759; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_transitions fk_rails_6e0f6eb833; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_edges fk_rails_7b4652ccf2; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_step_edges fk_rails_93ec0bf6eb; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_transitions fk_rails_e8caec803c; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_steps named_steps_dependent_system_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks_named_steps named_tasks_named_steps_named_step_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_named_tasks_named_steps named_tasks_named_steps_named_task_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_annotations task_annotations_annotation_type_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_task_annotations task_annotations_task_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_tasks tasks_named_task_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_steps workflow_steps_named_step_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
...
--
-- Name: tasker_workflow_steps workflow_steps_task_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: tasker
--
