...
--
-- Name: dlq_reason; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.dlq_reason AS ENUM (
    'staleness_timeout',
...
--
-- Name: TYPE dlq_reason; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TYPE public.dlq_reason IS 'TAS-49: Reasons a task is sent to DLQ. Determines investigation priority and remediation approach.';


--
-- Name: dlq_resolution_status; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.dlq_resolution_status AS ENUM (
    'pending',
    'manually_resolved',
    'permanently_failed',
    'cancelled'
...
--
-- Name: TYPE dlq_resolution_status; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TYPE public.dlq_resolution_status IS 'TAS-49: DLQ investigation status (separate from task state).
...
--
-- Name: calculate_staleness_threshold(character varying, jsonb, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calculate_staleness_threshold(p_task_state character varying, p_template_config jsonb, p_default_waiting_deps integer DEFAULT 60, p_default_waiting_retry integer DEFAULT 30, p_default_steps_process integer DEFAULT 30) RETURNS integer
...
--
-- Name: FUNCTION calculate_staleness_threshold(p_task_state character varying, p_template_config jsonb, p_default_waiting_deps integer, p_default_waiting_retry integer, p_default_steps_process integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.calculate_staleness_threshold(p_task_state character varying, p_template_config jsonb, p_default_waiting_deps integer, p_default_waiting_retry integer, p_default_steps_process integer) IS 'TAS-49 Phase 2: Calculate staleness threshold for a task state.
...
--
-- Name: create_dlq_entry(uuid, character varying, character varying, character varying, integer, integer, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_dlq_entry(p_task_uuid uuid, p_namespace_name character varying, p_task_name character varying, p_current_state character varying, p_time_in_state_minutes integer, p_threshold_minutes integer, p_dlq_reason character varying DEFAULT 'staleness_timeout'::character varying) RETURNS uuid
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: FUNCTION create_dlq_entry(p_task_uuid uuid, p_namespace_name character varying, p_task_name character varying, p_current_state character varying, p_time_in_state_minutes integer, p_threshold_minutes integer, p_dlq_reason character varying); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.create_dlq_entry(p_task_uuid uuid, p_namespace_name character varying, p_task_name character varying, p_current_state character varying, p_time_in_state_minutes integer, p_threshold_minutes integer, p_dlq_reason character varying) IS 'TAS-49 Phase 2: Create DLQ entry for a stale task with comprehensive snapshot.
...
--
-- Name: create_step_result_audit(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_step_result_audit() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_task_uuid UUID;
...
--
-- Name: FUNCTION detect_and_transition_stale_tasks(p_dry_run boolean, p_batch_size integer, p_default_waiting_deps_threshold integer, p_default_waiting_retry_threshold integer, p_default_steps_in_process_threshold integer, p_default_task_max_lifetime_hours integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.detect_and_transition_stale_tasks(p_dry_run boolean, p_batch_size integer, p_default_waiting_deps_threshold integer, p_default_waiting_retry_threshold integer, p_default_steps_in_process_threshold integer, p_default_task_max_lifetime_hours integer) IS 'TAS-49: Main orchestration function for automatic staleness detection and DLQ processing.
...
--
-- Name: evaluate_step_state_readiness(text, boolean, boolean, boolean, boolean, boolean, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.evaluate_step_state_readiness(current_state text, processed boolean, in_process boolean, dependencies_satisfied boolean, retry_eligible boolean, retryable boolean, next_retry_time timestamp without time zone) RETURNS boolean
    LANGUAGE sql STABLE
    AS $$
    SELECT
...
--
-- Name: find_stuck_tasks(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.find_stuck_tasks(p_timeout_minutes integer DEFAULT 10) RETURNS TABLE(task_uuid uuid, current_state character varying, processor_uuid uuid, stuck_duration_minutes integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_current_task_state(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_current_task_state(p_task_uuid uuid) RETURNS character varying
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_state VARCHAR;
...
--
-- Name: get_next_ready_task(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_next_ready_task() RETURNS TABLE(task_uuid uuid, task_name character varying, priority integer, namespace_name character varying, ready_steps_count bigint, computed_priority numeric, current_state character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: get_next_ready_tasks(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_next_ready_tasks(p_limit integer DEFAULT 5) RETURNS TABLE(task_uuid uuid, task_name character varying, priority integer, namespace_name character varying, ready_steps_count bigint, computed_priority numeric, current_state character varying)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: FUNCTION get_next_ready_tasks(p_limit integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_next_ready_tasks(p_limit integer) IS 'TAS-48: Returns ready tasks with staleness filtering (1A) and exponential priority decay (1B).
...
--
-- Name: get_slowest_steps(timestamp with time zone, integer, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_slowest_tasks(timestamp with time zone, integer, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_stale_tasks_for_dlq(integer, integer, integer, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_stale_tasks_for_dlq(p_default_waiting_deps integer DEFAULT 60, p_default_waiting_retry integer DEFAULT 30, p_default_steps_process integer DEFAULT 30, p_max_lifetime_hours integer DEFAULT 24, p_batch_size integer DEFAULT 100) RETURNS TABLE(task_uuid uuid, namespace_name character varying, task_name character varying, current_state character varying, time_in_state_minutes numeric, threshold_minutes integer, task_age_minutes numeric)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION get_stale_tasks_for_dlq(p_default_waiting_deps integer, p_default_waiting_retry integer, p_default_steps_process integer, p_max_lifetime_hours integer, p_batch_size integer); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_stale_tasks_for_dlq(p_default_waiting_deps integer, p_default_waiting_retry integer, p_default_steps_process integer, p_max_lifetime_hours integer, p_batch_size integer) IS 'TAS-49 Phase 2: Discover stale tasks exceeding thresholds with O(1) optimization.
...
--
-- Name: get_step_readiness_status(uuid, uuid[]); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_step_readiness_status(input_task_uuid uuid, step_uuids uuid[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_step_readiness_status(input_task_uuid uuid, step_uuids uuid[]) IS 'Optimized step readiness analysis function with task-scoped CTEs for performance.
...
--
-- Name: get_step_readiness_status_batch(uuid[], uuid[]); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION get_step_readiness_status_batch(input_task_uuids uuid[], step_uuids uuid[]); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_step_readiness_status_batch(input_task_uuids uuid[], step_uuids uuid[]) IS 'FIXED: Batch step readiness with corrected retry_eligible logic.
...
--
-- Name: get_step_transitive_dependencies(uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_task_execution_context(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_task_execution_context(input_task_uuid uuid) RETURNS TABLE(task_uuid uuid, named_task_uuid uuid, status text, total_steps bigint, pending_steps bigint, in_progress_steps bigint, completed_steps bigint, failed_steps bigint, ready_steps bigint, execution_status text, recommended_action text, completion_percentage numeric, health_status text, enqueued_steps bigint)
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_task_execution_contexts_batch(uuid[]); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_task_execution_contexts_batch(input_task_uuids uuid[]) RETURNS TABLE(task_uuid uuid, named_task_uuid uuid, status text, total_steps bigint, pending_steps bigint, in_progress_steps bigint, completed_steps bigint, failed_steps bigint, ready_steps bigint, execution_status text, recommended_action text, completion_percentage numeric, health_status text, enqueued_steps bigint)
    LANGUAGE plpgsql STABLE
    AS $$
BEGIN
  RETURN QUERY
...
--
-- Name: get_task_ready_info(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_task_ready_info(p_task_uuid uuid) RETURNS TABLE(task_uuid uuid, task_name character varying, priority integer, namespace_name character varying, ready_steps_count bigint, computed_priority numeric, current_state character varying)
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: set_step_backoff_atomic(uuid, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_step_backoff_atomic(p_step_uuid uuid, p_backoff_seconds integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: transition_stale_task_to_error(uuid, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.transition_stale_task_to_error(p_task_uuid uuid, p_current_state character varying, p_namespace_name character varying, p_task_name character varying) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_success BOOLEAN;
...
--
-- Name: FUNCTION transition_stale_task_to_error(p_task_uuid uuid, p_current_state character varying, p_namespace_name character varying, p_task_name character varying); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.transition_stale_task_to_error(p_task_uuid uuid, p_current_state character varying, p_namespace_name character varying, p_task_name character varying) IS 'TAS-49 Phase 2: Transition stale task to Error state with proper error handling.
...
--
-- Name: transition_task_state_atomic(uuid, character varying, character varying, uuid, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.transition_task_state_atomic(p_task_uuid uuid, p_from_state character varying, p_to_state character varying, p_processor_uuid uuid, p_metadata jsonb DEFAULT '{}'::jsonb) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_sort_key INTEGER;
...
--
-- Name: FUNCTION transition_task_state_atomic(p_task_uuid uuid, p_from_state character varying, p_to_state character varying, p_processor_uuid uuid, p_metadata jsonb); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.transition_task_state_atomic(p_task_uuid uuid, p_from_state character varying, p_to_state character varying, p_processor_uuid uuid, p_metadata jsonb) IS 'TAS-41/TAS-49/TAS-54: Atomic state transition without ownership enforcement.
...
COMMENT ON FUNCTION public.update_updated_at_column() IS 'TAS-49: Trigger function to automatically update updated_at timestamp on row modification';
...
--
-- Name: COLUMN tasker_workflow_steps.checkpoint; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_workflow_steps.checkpoint IS 'Handler-driven checkpoint data for batch processing resumability (TAS-125)';
...
--
-- Name: COLUMN tasker_tasks.correlation_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_tasks.correlation_id IS 'UUID v7 correlation ID for distributed tracing (NOT NULL). Auto-generated if not provided at task creation. Enables end-to-end request tracking across orchestration and workers.';


--
-- Name: COLUMN tasker_tasks.parent_correlation_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_tasks.parent_correlation_id IS 'Optional correlation ID of parent workflow. Enables tracking of nested/chained workflow relationships.';


--
-- Name: tasker_tasks_dlq; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tasker_tasks_dlq (
    dlq_entry_uuid uuid DEFAULT public.uuid_generate_v7() NOT NULL,
    task_uuid uuid NOT NULL,
    original_state character varying(50) NOT NULL,
    dlq_reason public.dlq_reason NOT NULL,
    dlq_timestamp timestamp without time zone DEFAULT now() NOT NULL,
    resolution_status public.dlq_resolution_status DEFAULT 'pending'::public.dlq_resolution_status NOT NULL,
...
--
-- Name: TABLE tasker_tasks_dlq; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.tasker_tasks_dlq IS 'TAS-49: Dead Letter Queue investigation tracking and audit trail.
...
--
-- Name: COLUMN tasker_tasks_dlq.task_snapshot; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_tasks_dlq.task_snapshot IS 'Complete snapshot of task state when moved to DLQ.
Includes task details, steps, transitions, and execution context.
Enables investigation without modifying main task tables.';


--
-- Name: COLUMN tasker_tasks_dlq.metadata; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_tasks_dlq.metadata IS 'Additional context about DLQ entry.
Examples: error stack trace, detection method, related tasks, investigation notes.';


--
-- Name: tasker_workflow_step_result_audit; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tasker_workflow_step_result_audit (
    workflow_step_result_audit_uuid uuid DEFAULT public.uuid_generate_v7() NOT NULL,
...
--
-- Name: TABLE tasker_workflow_step_result_audit; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.tasker_workflow_step_result_audit IS 'Lightweight audit trail for workflow step execution results. Stores references and attribution only - full results accessed via JOIN to transitions table. Created by TAS-62.';


--
-- Name: COLUMN tasker_workflow_step_result_audit.worker_uuid; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_workflow_step_result_audit.worker_uuid IS 'UUID of the worker that processed this step (attribution for SOC2 compliance)';


--
-- Name: COLUMN tasker_workflow_step_result_audit.correlation_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_workflow_step_result_audit.correlation_id IS 'Correlation ID for distributed tracing across the orchestration system';


--
-- Name: COLUMN tasker_workflow_step_result_audit.success; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_workflow_step_result_audit.success IS 'Whether the step execution succeeded (extracted from transition for indexing)';


--
-- Name: COLUMN tasker_workflow_step_result_audit.execution_time_ms; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.tasker_workflow_step_result_audit.execution_time_ms IS 'Step execution time in milliseconds (extracted from transition for filtering)';
...
--
-- Name: v_dlq_dashboard; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_dlq_dashboard AS
 SELECT dlq_reason,
    count(*) AS total_entries,
    count(*) FILTER (WHERE (resolution_status = 'pending'::public.dlq_resolution_status)) AS pending,
    count(*) FILTER (WHERE (resolution_status = 'manually_resolved'::public.dlq_resolution_status)) AS manually_resolved,
    count(*) FILTER (WHERE (resolution_status = 'permanently_failed'::public.dlq_resolution_status)) AS permanent_failures,
    count(*) FILTER (WHERE (resolution_status = 'cancelled'::public.dlq_resolution_status)) AS cancelled,
   ...
   FROM public.tasker_tasks_dlq
  GROUP BY dlq_reason;


--
-- Name: VIEW v_dlq_dashboard; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.v_dlq_dashboard IS 'TAS-49: High-level DLQ metrics for monitoring and alerting.
...
--
-- Name: v_dlq_investigation_queue; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_dlq_investigation_queue AS
 SELECT dlq_entry_uuid,
    ...
    ((
        CASE dlq_reason
            WHEN 'dependency_cycle_detected'::public.dlq_reason THEN 1000
            WHEN 'max_retries_exceeded'::public.dlq_reason THEN 500
            WHEN 'staleness_timeout'::public.dlq_reason THEN 100
            WHEN 'worker_unavailable'::public.dlq_reason THEN 50
            ELSE 10
        END)::numeric + (EXTRACT(epoch FROM (now() - (dlq_timestamp)::timestamp with time zone)) / (60)::numeric)) AS priority_score
   FROM public.tasker_tasks_dlq dlq
  WHERE (resolution_status = 'pending'::public.dlq_resolution_status)
  ORDER BY ((
        CASE dlq_reason
            WHEN 'dependency_cycle_detected'::public.dlq_reason THEN 1000
            WHEN 'max_retries_exceeded'::public.dlq_reason THEN 500
...
--
-- Name: VIEW v_dlq_investigation_queue; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.v_dlq_investigation_queue IS 'TAS-49: Prioritized queue of pending DLQ investigations.
...
--
-- Name: v_task_state_analysis; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_task_state_analysis AS
 SELECT t.task_uuid,
    t.correlation_id,
    tns.name AS namespace_name,
   ...
   FROM (((public.tasker_tasks t
     JOIN public.tasker_named_tasks nt ON ((nt.named_task_uuid = t.named_task_uuid)))
     JOIN public.tasker_task_namespaces tns ON ((tns.task_namespace_uuid = nt.task_namespace_uuid)))
     JOIN public.tasker_task_transitions tt ON (((tt.task_uuid = t.task_uuid) AND (tt.most_recent = true))))
  WHERE (t.complete = false);


--
-- Name: VIEW v_task_state_analysis; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.v_task_state_analysis IS 'TAS-49: Base view for task state analysis with namespace and template information.
...
--
-- Name: v_task_staleness_monitoring; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_task_staleness_monitoring AS
 SELECT task_uuid,
    namespace_name,
    task_name,
    current_state,
    ...
    task_age_minutes,
    public.calculate_staleness_threshold(current_state, template_config, 60, 30, 30) AS staleness_threshold_minutes,
        CASE
            WHEN (time_in_state_minutes >= (public.calculate_staleness_threshold(current_state, template_config, 60, 30, 30))::numeric) THEN 'stale'::text
            WHEN (time_in_state_minutes >= ((public.calculate_staleness_threshold(current_state, template_config, 60, 30, 30))::numeric * 0.8)) THEN 'warning'::text
            ELSE 'healthy'::text
        END AS health_status,
    priority
   FROM public.v_task_state_analysis tsa
...
--
-- Name: VIEW v_task_staleness_monitoring; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.v_task_staleness_monitoring IS 'TAS-49: Real-time staleness monitoring for active tasks.
...
--
-- Name: tasker_annotation_types tasker_annotation_types_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_annotation_types tasker_annotation_types_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_dependent_systems tasker_dependent_systems_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_dependent_systems tasker_dependent_systems_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_steps tasker_named_steps_system_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_tasks_named_steps tasker_named_tasks_named_steps_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_tasks tasker_named_tasks_namespace_name_version_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_task_namespaces tasker_task_namespaces_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_task_namespaces tasker_task_namespaces_name_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_tasks_dlq tasker_tasks_dlq_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_tasks_dlq
    ADD CONSTRAINT tasker_tasks_dlq_pkey PRIMARY KEY (dlq_entry_uuid);
...
--
-- Name: tasker_workflow_step_result_audit tasker_workflow_step_result_audit_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_workflow_step_result_audit
    ADD CONSTRAINT tasker_workflow_step_result_audit_pkey PRIMARY KEY (workflow_step_result_audit_uuid);
...
--
-- Name: tasker_workflow_step_edges unique_edge_per_step_pair; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: CONSTRAINT unique_edge_per_step_pair ON tasker_workflow_step_edges; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON CONSTRAINT unique_edge_per_step_pair ON public.tasker_workflow_step_edges IS 'Prevents duplicate edges between the same two steps with the same edge name. Critical for batch processing worker creation idempotency.';


--
-- Name: tasker_workflow_step_result_audit uq_audit_step_transition; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX idx_audit_correlation_id ON public.tasker_workflow_step_result_audit USING btree (correlation_id) WHERE (correlation_id IS NOT NULL);


--
-- Name: idx_audit_recorded_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_recorded_at ON public.tasker_workflow_step_result_audit USING btree (recorded_at);


--
-- Name: idx_audit_step_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_step_uuid ON public.tasker_workflow_step_result_audit USING btree (workflow_step_uuid);
...
CREATE INDEX idx_audit_success ON public.tasker_workflow_step_result_audit USING btree (success);


--
-- Name: idx_audit_task_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_task_uuid ON public.tasker_workflow_step_result_audit USING btree (task_uuid);


--
-- Name: idx_audit_worker_uuid; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_worker_uuid ON public.tasker_workflow_step_result_audit USING btree (worker_uuid) WHERE (worker_uuid IS NOT NULL);


--
-- Name: idx_dlq_reason; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dlq_reason ON public.tasker_tasks_dlq USING btree (dlq_reason);


--
-- Name: idx_dlq_resolution_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dlq_resolution_status ON public.tasker_tasks_dlq USING btree (resolution_status, dlq_timestamp);


--
-- Name: idx_dlq_task_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dlq_task_lookup ON public.tasker_tasks_dlq USING btree (task_uuid);


--
-- Name: idx_dlq_timestamp; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_dlq_timestamp ON public.tasker_tasks_dlq USING btree (dlq_timestamp DESC);


--
-- Name: idx_dlq_unique_pending_task; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX idx_dlq_unique_pending_task ON public.tasker_tasks_dlq USING btree (task_uuid) WHERE (resolution_status = 'pending'::public.dlq_resolution_status);


--
-- Name: INDEX idx_dlq_unique_pending_task; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.idx_dlq_unique_pending_task IS 'TAS-49: Ensures only one pending DLQ investigation per task.
...
--
-- Name: idx_named_tasks_lifecycle_config; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_named_tasks_lifecycle_config ON public.tasker_named_tasks USING gin (((configuration -> 'lifecycle'::text))) WHERE ((configuration -> 'lifecycle'::text) IS NOT NULL);


--
-- Name: INDEX idx_named_tasks_lifecycle_config; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON INDEX public.idx_named_tasks_lifecycle_config IS 'TAS-49 Phase 2: GIN index for lifecycle configuration JSONB path queries.
...
--
-- Name: idx_task_transitions_processor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_task_transitions_processor ON public.tasker_task_transitions USING btree (processor_uuid) WHERE (processor_uuid IS NOT NULL);


--
-- Name: idx_task_transitions_state_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_task_transitions_timeout; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_task_transitions_timeout ON public.tasker_task_transitions USING btree (((transition_metadata ->> 'timeout_at'::text))) WHERE (most_recent = true);


--
-- Name: idx_task_transitions_uuid_most_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_task_transitions_uuid_sort_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_task_transitions_uuid_temporal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_dependent_systems_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_named_steps_system_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_named_tasks_namespace_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_task_annotations_task_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_task_annotations_type_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_task_namespaces_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_task_transitions_most_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_task_transitions_task_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_complete; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_completed_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_correlation_hierarchy; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tasker_tasks_correlation_hierarchy ON public.tasker_tasks USING btree (parent_correlation_id, correlation_id) WHERE (parent_correlation_id IS NOT NULL);


--
-- Name: idx_tasker_tasks_correlation_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tasker_tasks_correlation_id ON public.tasker_tasks USING btree (correlation_id);


--
-- Name: idx_tasker_tasks_identity_hash; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_named_task_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_parent_correlation_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tasker_tasks_parent_correlation_id ON public.tasker_tasks USING btree (parent_correlation_id) WHERE (parent_correlation_id IS NOT NULL);


--
-- Name: idx_tasker_tasks_priority; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_requested_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_source_system; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_tags_gin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_tasks_tags_gin_path; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_step_edges_from_step; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_step_edges_to_step; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_step_transitions_most_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_step_transitions_step_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_steps_named_step_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasker_workflow_steps_task_uuid; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasks_active_with_priority_covering; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_tasks_uuid_temporal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_step_edges_from_step_name; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_step_edges_from_step_name ON public.tasker_workflow_step_edges USING btree (from_step_uuid, name);


--
-- Name: idx_workflow_step_transitions_state_lookup; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_step_transitions_uuid_most_recent; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_step_transitions_uuid_sort_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_step_transitions_uuid_temporal; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_steps_active_operations; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_steps_checkpoint_cursor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_checkpoint_cursor ON public.tasker_workflow_steps USING btree (((checkpoint ->> 'cursor'::text))) WHERE (checkpoint IS NOT NULL);


--
-- Name: idx_workflow_steps_checkpoint_exists; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_checkpoint_exists ON public.tasker_workflow_steps USING btree (workflow_step_uuid) WHERE (checkpoint IS NOT NULL);


--
-- Name: idx_workflow_steps_processed_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_steps_processing_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_workflow_steps_ready_covering; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_ready_covering ON public.tasker_workflow_steps USING btree (task_uuid, processed, in_process) INCLUDE (workflow_step_uuid, attempts, max_attempts, retryable) WHERE (processed = false);


--
-- Name: idx_workflow_steps_retry_logic; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_retry_logic ON public.tasker_workflow_steps USING btree (attempts, max_attempts, retryable);


--
-- Name: idx_workflow_steps_retry_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_retry_status ON public.tasker_workflow_steps USING btree (attempts, max_attempts);


--
-- Name: idx_workflow_steps_task_covering; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_task_covering ON public.tasker_workflow_steps USING btree (task_uuid) INCLUDE (workflow_step_uuid, processed, in_process, attempts, max_attempts);
...
--
-- Name: idx_workflow_steps_transitive_deps; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_workflow_steps_transitive_deps ON public.tasker_workflow_steps USING btree (workflow_step_uuid, named_step_uuid) INCLUDE (task_uuid, processed);


--
-- Name: tasker_workflow_step_transitions trg_step_result_audit; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_step_result_audit AFTER INSERT ON public.tasker_workflow_step_transitions FOR EACH ROW EXECUTE FUNCTION public.create_step_result_audit();


--
-- Name: TRIGGER trg_step_result_audit ON tasker_workflow_step_transitions; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TRIGGER trg_step_result_audit ON public.tasker_workflow_step_transitions IS 'Creates audit records when workers persist step execution results (TAS-62)';


--
-- Name: tasker_tasks_dlq update_dlq_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_dlq_updated_at BEFORE UPDATE ON public.tasker_tasks_dlq FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: tasker_dependent_system_object_maps tasker_dependent_system_object_maps_dependent_system_one_uuid_f; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_dependent_system_object_maps tasker_dependent_system_object_maps_dependent_system_two_uuid_f; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_steps tasker_named_steps_dependent_system_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_tasks_named_steps tasker_named_tasks_named_steps_named_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_tasks_named_steps tasker_named_tasks_named_steps_named_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_named_tasks tasker_named_tasks_task_namespace_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_task_annotations tasker_task_annotations_annotation_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_task_annotations tasker_task_annotations_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_task_transitions tasker_task_transitions_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_tasks_dlq tasker_tasks_dlq_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_tasks_dlq
    ADD CONSTRAINT tasker_tasks_dlq_task_uuid_fkey FOREIGN KEY (task_uuid) REFERENCES public.tasker_tasks(task_uuid);


--
-- Name: tasker_tasks tasker_tasks_named_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_workflow_step_edges tasker_workflow_step_edges_from_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_workflow_step_edges tasker_workflow_step_edges_to_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_workflow_step_result_audit tasker_workflow_step_result_a_workflow_step_transition_uui_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_workflow_step_result_audit
    ADD CONSTRAINT tasker_workflow_step_result_a_workflow_step_transition_uui_fkey FOREIGN KEY (workflow_step_transition_uuid) REFERENCES public.tasker_workflow_step_transitions(workflow_step_transition_uuid);


--
-- Name: tasker_workflow_step_result_audit tasker_workflow_step_result_audit_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_workflow_step_result_audit
    ADD CONSTRAINT tasker_workflow_step_result_audit_task_uuid_fkey FOREIGN KEY (task_uuid) REFERENCES public.tasker_tasks(task_uuid);


--
-- Name: tasker_workflow_step_result_audit tasker_workflow_step_result_audit_workflow_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tasker_workflow_step_result_audit
    ADD CONSTRAINT tasker_workflow_step_result_audit_workflow_step_uuid_fkey FOREIGN KEY (workflow_step_uuid) REFERENCES public.tasker_workflow_steps(workflow_step_uuid);


--
-- Name: tasker_workflow_step_transitions tasker_workflow_step_transitions_workflow_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_workflow_steps tasker_workflow_steps_named_step_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tasker_workflow_steps tasker_workflow_steps_task_uuid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
