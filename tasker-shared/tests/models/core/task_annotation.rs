...
async fn test_task_annotation_crud(pool: PgPool) -> sqlx::Result<()> {
    ...
    let task = tasker_shared::models::task::Task::create(
        &pool,
        tasker_shared::models::task::NewTask {
    ...
    let annotation_type = tasker_shared::models::annotation_type::AnnotationType::create(
        &pool,
        tasker_shared::models::annotation_type::NewAnnotationType {
