...
#[tokio::test]
async fn test_successful_analytics_pipeline_ts() -> Result<()> {
    ...
    let task_request = create_data_pipeline_request_ts(&pipeline_id, date_range);
