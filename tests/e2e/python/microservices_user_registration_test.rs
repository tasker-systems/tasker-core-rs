...
fn create_user_registration_request_py(
    user_info: serde_json::Value,
) -> tasker_shared::models::core::task_request::TaskRequest {
    create_task_request("microservices_py", "user_registration_py", user_info)
}
...
#[tokio::test]
async fn test_successful_user_registration_py() -> Result<()> {
    ...
    println!("   Plan: pro");
    let task_request = create_user_registration_request_py(user_info);
