...
fn create_ecommerce_order_request_py(
...
#[tokio::test]
async fn test_successful_order_processing_py() -> Result<()> {
    ...
    let task_request = create_ecommerce_order_request_py(cart_items, customer_info, payment_info);
