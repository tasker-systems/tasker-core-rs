...
module TaskerCore
  module Types
    ...
    class TaskExecutionContext < BaseStruct
      ...
      attribute :total_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :completed_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :pending_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :error_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :ready_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :blocked_steps, Types::Coercible::Integer.constrained(gteq: 0)
      ...
      attribute :next_steps_to_execute, Types::Array.of(StepId)
      attribute :critical_path_steps, Types::Array.of(StepId)
      attribute :bottleneck_steps, Types::Array.of(StepId)
    ...
    class ViableStep < BaseStruct
      ...
      attribute :is_ready, Types::Bool
      attribute :estimated_duration_seconds, DurationSeconds.optional
      attribute :priority_score, Types::Coercible::Float.constrained(gteq: 0.0)
    ...
    class SystemHealth < BaseStruct
      ...
      attribute :active_tasks, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :pending_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :error_rate, Types::Coercible::Float.constrained(gteq: 0.0, lteq: 1.0)
      attribute :average_step_duration, Types::Coercible::Float.constrained(gteq: 0.0)
      attribute :system_load, Types::Coercible::Float.constrained(gteq: 0.0, lteq: 1.0)
      attribute :last_updated_at, Types::String # ISO8601 timestamp
    ...
    class AnalyticsMetrics < BaseStruct
      attribute :active_tasks_count, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :total_namespaces_count, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :unique_task_types_count, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :system_health_score, Types::Coercible::Float.constrained(gteq: 0.0, lteq: 1.0)
      attribute :task_throughput, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :completion_count, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :error_count, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :completion_rate, Types::Coercible::Float.constrained(gteq: 0.0, lteq: 1.0)
      attribute :error_rate, Types::Coercible::Float.constrained(gteq: 0.0, lteq: 1.0)
      attribute :avg_task_duration, Types::Coercible::Float.constrained(gteq: 0.0)
      attribute :avg_step_duration, Types::Coercible::Float.constrained(gteq: 0.0)
      attribute :step_throughput, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :analysis_period_start, Types::String # ISO8601 timestamp
      attribute :calculated_at, Types::String # ISO8601 timestamp
    ...
    class DependencyAnalysis < BaseStruct
      ...
      attribute :max_depth, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :parallel_branches, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :critical_path_length, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :total_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :ready_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :blocked_steps, Types::Coercible::Integer.constrained(gteq: 0)
      attribute :completion_percentage, Percentage
      ...
      attribute :parallelization_factor, Types::Coercible::Float.constrained(gteq: 0.0)
    ...
    class StepContext < BaseStruct
      ...
      attribute :attempt_number, Types::Coercible::Integer.constrained(gteq: 1).default(1)
      attribute :max_attempts, Types::Coercible::Integer.constrained(gteq: 1).default(3)
      attribute :config, ContextData.optional
      attribute :created_at, Types::String # ISO8601 timestamp
      attribute :started_at, Types::String.optional # ISO8601 timestamp
    ...
    class TaskContext < BaseStruct
      ...
      attribute :priority, Types::Coercible::Integer.constrained(gteq: 0).default(0)
      attribute :config, ContextData.optional
      attribute :created_at, Types::String # ISO8601 timestamp
      attribute :started_at, Types::String.optional # ISO8601 timestamp
      attribute :completed_at, Types::String.optional # ISO8601 timestamp
      ...
      def can_retry?
        !%w[complete cancelled].include?(status)
      end
