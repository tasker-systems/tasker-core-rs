...
RSpec.describe 'Diamond Workflow Integration', type: :integration do
  let(:config_path) { File.expand_path('../handlers/examples/diamond_workflow/config/diamond_workflow_handler.yaml', __dir__) }
      ...
      begin
        ...
        Timeout.timeout(60) do
          loop do
            ...
            if (Time.now - start_time).to_i % 2 == 0  # Every 2 seconds
            ...
            if system_health['running_steps'] && system_health['running_steps'] >= 2
              unless parallel_branches_started
            ...
            if system_health['completed_steps'] && system_health['completed_steps'] >= 3
              unless parallel_branches_completed
