...
RSpec.describe TaskerCore::Database::SqlFunctions do
  ...
  before do
    allow(mock_result).to receive(:ntuples).and_return(0)
    allow(mock_result).to receive(:map).and_return([])
  ...
  describe 'SQL function signatures and type casting' do
    ...
    describe '#execute_function' do
      it 'builds correct SQL with parameter placeholders' do
        ...
        sql_functions.execute_function('get_task_execution_context', 12345)
      end
  ...
  describe 'result parsing validation' do
    ...
    it 'parses task execution context correctly' do
      result = sql_functions.task_execution_context(12345)
  ...
  describe 'error handling' do
    ...
    it 'includes function context in error message' do
      expect { sql_functions.task_execution_context(123) }.to raise_error(TaskerCore::Error, /Failed to get task execution context/)
    end
  end
end