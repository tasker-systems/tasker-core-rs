...
use tasker_shared::messaging::{UnifiedPgmqClient, PgmqClientTrait};
...
impl OrchestrationResultSender {
    ...
    pub fn new(pgmq_client: Arc<UnifiedPgmqClient>, queue_config: QueueConfig, orchestration_namespace: String) -> Self {
    ...
    pub async fn send_completion(&self, task_uuid: Uuid, step_uuid: Uuid) -> TaskerResult<()> {
        ...
        let queue_name = self.queue_classifier.ensure_orchestration_prefix(
    ...
    pub fn step_results_queue(&self) -> String {
        self.queue_classifier.ensure_orchestration_prefix(
            self.queue_classifier.step_results_queue_name()
        )
    }
}
...
mod tests {
    ...
    fn test_orchestration_result_sender_creation() {
        ...
        let step_results_queue = queue_classifier.ensure_orchestration_prefix(
