...
pub struct StepTemplate {
    ...
    #[serde(
        deserialize_with = "tasker_shared::utils::serde::deserialize_optional_numeric",
        default
    )]
...
impl HandlerConfiguration {
    ...
    pub fn from_yaml(yaml_content: &str) -> TaskerResult<Self> {
    ...
    pub fn from_yaml_file(file_path: &std::path::Path) -> TaskerResult<Self> {
    ...
    pub fn resolve_for_environment(
        &self,
        environment: &str,
    ) -> TaskerResult<ResolvedHandlerConfiguration> {
    ...
    fn resolve_default_context(&self, environment: &str) -> TaskerResult<serde_json::Value> {
    ...
    fn resolve_default_options(
        &self,
        environment: &str,
    ) -> TaskerResult<HashMap<String, serde_json::Value>> {
