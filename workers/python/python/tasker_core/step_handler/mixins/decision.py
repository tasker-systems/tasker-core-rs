...
routing decisions. Use via multiple inheritance with StepHandler base class.
...
class DecisionMixin:
    """Mixin class providing decision point functionality.
    ...
    Example:
        >>> class CustomerTierRouter(DecisionMixin, StepHandler):
    ...
    @property
    def decision_capabilities(self) -> list[str]:
        """Return decision-specific capabilities."""
