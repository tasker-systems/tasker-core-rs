...
functionality. Use via multiple inheritance with StepHandler base class.
...
class APIMixin:
    """Mixin class providing HTTP API functionality.

    TAS-112: Use via multiple inheritance with StepHandler.
    ...
    Example:
        >>> class PaymentApiHandler(APIMixin, StepHandler):
    ...
    def __init__(self) -> None:
        """Initialize the APIMixin."""
        super().__init__()
        self._client: httpx.Client | None = None

    @property
    def api_capabilities(self) -> list[str]:
        """Return API-specific capabilities."""
        return ["http", "api"]
