...
-- tasker_development will be replaced by specific scripts
GRANT ALL PRIVILEGES ON DATABASE tasker_development TO tasker;
...
BEGIN
    ...
    RAISE NOTICE 'Database: tasker_development';
