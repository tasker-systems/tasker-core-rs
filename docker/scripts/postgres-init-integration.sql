...
-- tasker_integration will be replaced by specific scripts
GRANT ALL PRIVILEGES ON DATABASE tasker_integration TO tasker;
...
BEGIN
    ...
    RAISE NOTICE 'Database: tasker_integration';
