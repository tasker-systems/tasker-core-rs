...
-- tasker_production will be replaced by specific scripts
GRANT ALL PRIVILEGES ON DATABASE tasker_production TO tasker;
...
BEGIN
    ...
    RAISE NOTICE 'Database: tasker_production';
